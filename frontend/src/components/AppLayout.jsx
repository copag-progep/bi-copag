...
const pageTitles = {
  ...
  "/":                    { eyebrow: "Workspace",         title: "Área de Trabalho" },
  "/enviar-relatorio":    { eyebrow: "Administração",     title: "Gestão de Dados" },
  "/entradas-saidas":     { eyebrow: "Desempenho",        title: "Fluxo" },
  "/movimentacoes":       { eyebrow: "Desempenho",        title: "Movimentações" },
  "/produtividade":       { eyebrow: "Desempenho",        title: "Produtividade" },
  "/multiplos-setores":   { eyebrow: "Consistência",      title: "Inconsistências" },
  ...
  "/servidores":          { eyebrow: "Gestão de carga",   title: "Pessoas" },
