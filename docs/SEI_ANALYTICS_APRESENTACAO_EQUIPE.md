...
De segunda a sexta, às 18:17 no horário de Fortaleza/Brasília, uma automação no GitHub Actions executa o script `scripts/sei_uploader.py`. Às 18:47, uma recuperação verifica se o upload principal teve sucesso e só repete a coleta quando ainda for necessário.
...
|---|---|---|
| `daily-upload` | Segunda a sexta, 18:17 e 18:47 BRT | Coleta dados do SEI; a segunda execução recupera o dia somente quando ainda não houve sucesso |
| `daily-report` | Segunda a sexta, 19:07 BRT | Confirma se o upload do dia teve sucesso e, se estiver tudo certo, envia e-mail diário compacto com principais indicadores |
...
Ele roda às 19:07 para dar tempo de o upload principal das 18:17 e, se necessário, a recuperação das 18:47 terminarem.
...
| `pauta_itens` | Processos priorizados na pauta | Guarda responsáveis, prazo, nota da gestão, risco e status de cada processo acompanhado |
...
- O upload automático principal roda às 18:17 e possui recuperação às 18:47 quando necessário.
- O relatório diário é enviado às 19:07.
...
- O relatório diário às 19:07 depende de um upload bem-sucedido no dia; se nem a execução principal nem a recuperação tiverem sucesso, o envio é bloqueado automaticamente.
